...
get_msg_containment("r3_hex_pb_versions") -> ['Package', 'Versions'];
...
get_proto_by_msg_name_as_fqbin(<<"Versions">>) -> "r3_hex_pb_versions";
get_proto_by_msg_name_as_fqbin(<<"Package">>) -> "r3_hex_pb_versions";
